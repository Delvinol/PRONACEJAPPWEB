...
@Component({
  selector: 'app-situacioneducativapaspe',
  standalone: true,
  imports: [CommonModule, FormsModule, MatDatepickerModule, MatNativeDateModule, MatInputModule],
  templateUrl: './situacioneducativapaspe.component.html',
  styleUrl: './situacioneducativapaspe.component.css'
})
export class SituacioneducativapaspeComponent {
  ...
  searchData() {
    ...
    this.router.navigate(['/grsituacioneducativapaspe'], {
      queryParams: {
        fecha: formattedDate,
