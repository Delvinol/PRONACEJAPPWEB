...
@Component({
  selector: 'app-grsituacioneducativapaspe',
  standalone: true,
  imports: [],
  templateUrl: './grsituacioneducativapaspe.component.html',
  styleUrl: './grsituacioneducativapaspe.component.css'
})
export class GrsituacioneducativapaspeComponent {
  ...
  constructor(
    ...
    private soaService: PaspeService
  ) {}
  ...
  private getData(fecha: string, isActive: boolean) {
    this.soaService.getSituacionEducativaData(fecha, isActive).subscribe(data => {
  ...
  onBack() {
    this.router.navigate(['/situacioneducativapaspe']);
  }
