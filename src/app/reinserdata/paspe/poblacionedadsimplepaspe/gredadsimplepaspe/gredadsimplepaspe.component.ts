...
@Component({
  selector: 'app-gredadsimplepaspe',
  standalone: true,
  imports: [],
  templateUrl: './gredadsimplepaspe.component.html',
  styleUrl: './gredadsimplepaspe.component.css'
})
export class GredadsimplepaspeComponent {
