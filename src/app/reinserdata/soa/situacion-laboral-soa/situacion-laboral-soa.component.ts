...
@Component({
  selector: 'app-situacion-laboral-soa',
  standalone: true,
  imports: [CommonModule, FormsModule, MatDatepickerModule, MatNativeDateModule, MatInputModule],
  templateUrl: './situacion-laboral-soa.component.html',
  styleUrl: './situacion-laboral-soa.component.css'
})
export class SituacionLaboralSOAComponent implements OnInit {
  ...
  searchData() {
    ...
    this.router.navigate(['/grSituacionLaboralSOA'], {
      queryParams: {
        fecha: formattedDate,
