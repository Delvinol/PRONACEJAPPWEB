...
@Component({
  selector: 'app-infracciones-cometidas-soa',
  standalone: true,
  imports: [CommonModule, FormsModule, MatDatepickerModule, MatNativeDateModule, MatInputModule],
  templateUrl: './infracciones-cometidas-soa.component.html',
  styleUrl: './infracciones-cometidas-soa.component.css'
})
export class InfraccionesCometidasSOAComponent {
  ...
  searchData() {
    ...
    this.router.navigate(['/grInfraccionCometidaSOA'], {
      queryParams: {
        fecha: formattedDate,
