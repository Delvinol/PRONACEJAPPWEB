...
@Component({
  selector: 'app-gr-situacion-educativa-actual-soa',
  standalone: true,
  imports: [],
  templateUrl: './gr-situacion-educativa-actual-soa.component.html',
  styleUrl: './gr-situacion-educativa-actual-soa.component.css'
})
export class GrSituacionEducativaActualSOAComponent {
